...
export default function Home() {
  return (
    <main className="flex h-screen  gap-4 sm:p-4 p-0 bg-primaryCol text-secondaryCol">
      <div className="flex-1 h-full relative bg-landing-hero md:bg-left bg-center bg-cover sm:rounded-[20px] rounded-none flex flex-col justify-between items-start sm:p-8 p-4">
        <NavBar />
